          ...
          <el-row>
            <el-col :span="6">
              <el-form-item label="会员姓名:" prop="name" style="">
                <el-input size="middle" style="width: 180px;" prefix-icon="el-icon-edit" v-model="customerForm.name"
            ...
            <el-col :span="6">
              <el-form-item label="手机号码:" prop="phone">
                <el-input size="middle" style="width: 150px;" prefix-icon="el-icon-phone" v-model="customerForm.phone"
                  placeholder="请输入手机号码"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="6">
              <el-form-item label="见诊日期:" prop="visittime">
                <el-date-picker size="middle" style="width: 150px;" v-model="customerForm.visittime" type="date"
                  value-format="yyyy-MM-dd" placeholder="见诊日期">
                </el-date-picker>
              </el-form-item>
            </el-col>
            ...
            <el-col :span="6">
              <el-form-item label="咨询师:" prop="consultteach">
                <el-select filterable style="width: 150px;" v-model="customerForm.consultteach" placeholder="请选择咨询师">
                  <el-option v-for="item in consultteachList" :key="item.Id" :label="item.Name" :value="item.Name">
                  </el-option>
                </el-select>
              </el-form-item>
            </el-col>
